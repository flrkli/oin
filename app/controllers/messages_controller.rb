class MessagesController < ApplicationController
	...
	def index
		...
		@path = [link_to_user(@user), link_to_messages]
		@subnavigation = [link_to_user(@user), link_to_edit_user_user_detail(@user), link_to_user_user_detail(@user), active_link_to_messages]
  end
  ...
  def new
		...
		@path = [link_to_user(@user), link_to_messages, link_to_new_message]
		@subnavigation = [link_to_user(@user), link_to_edit_user_user_detail(@user), link_to_user_user_detail(@user), active_link_to_messages]
  end
  ...
  def box
		...
		@path = [link_to_user(@user), link_to_messages, link_to_box(@type)]
		@subnavigation = [link_to_user(@user), link_to_edit_user_user_detail(@user), link_to_user_user_detail(@user), active_link_to_messages]
  end
